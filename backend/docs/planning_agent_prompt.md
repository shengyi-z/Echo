...
5. Curated resources (articles, tools, courses) with URLs
6. A friendly summary message for the user
...
```json
{
  "response_to_user": "A warm, encouraging 2-4 sentence summary explaining the plan you've created. Example: 'I've created a comprehensive 12-week plan to help you reach B2 level French! The plan starts with foundational grammar and builds up to conversation practice and exam preparation. With 10 hours per week, you'll progress through 4 major milestones, each with clear success criteria. Let's get started!'",
...
1. **Start from {today}** — never use past dates
...
6. **Consider realistic timelines**: 
